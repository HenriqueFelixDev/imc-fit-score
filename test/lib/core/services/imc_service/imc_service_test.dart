  ...
  group('getIMC Tests |', () {
    ...
    test('should return right IMC status', () {
      final inputs = <Map<String, dynamic>>[
        {
          ...
          'height': 1.70,
          'imc': 16.99,
          'expected': IMCStatus.veryUnderweight
        },
        {
          'weight': 2.5,
          'height': 0.45,
        ...
        },
        {
          ...
          'height': 1.70,
          'imc': 17.0,
          'expected': IMCStatus.underweight
        },
        {
          'weight': 59.3,
          'height': 1.82,
        ...
        },
        {
          ...
          'height': 1.68,
          'imc': 30.0,
          'expected': IMCStatus.obeseClass1
        },
        {
          'weight': 122.38,
          'height': 1.87,
        ...
        },
        {
          ...
          'height': 1.58,
          'imc': 35.0,
          'expected': IMCStatus.obeseClass2
        },
        {
          'weight': 96.09,
          'height': 1.55,
        ...
        },
        {
          ...
          'height': 1.66,
          'imc': 40.0,
          'expected': IMCStatus.obeseClass3
        },
        {
          'weight': 177.97,
          'height': 1.85,
      ...
      for (final input in inputs) {
        ...
        final IMCResult(:imc, :status) = imcService.getIMC(height, weight);
    ...
    test('should return assertion error', () {
      ...
      for (final input in inputs) {
        ...
        expect(() => imcService.getIMC(height, weight), throwsAssertionError);
      }
    });
    ...
    test('should return InvalidIMCException', () {
      ...
      for (final input in inputs) {
        ...
        expect(() => imcService.getIMC(height, weight),
            throwsA(isA<InvalidIMCException>()));
      }
    });
  });
}
